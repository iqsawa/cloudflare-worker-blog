...
const github_base = "iqsawa/cloudflare-worker-blog";

// 站点名称
const site_name = "青松awaのBlog";

// 站点介绍
const site_desc = "我的博客";
...
// Copyright
const copyright = `&copy; 2025 ${site_name} | <a href="https://github.com/iqsawa/cloudflare-worker-blog" target="_blank">Github</a>`;
